...
template<class TYPE> 
Destroyer<TYPE>::Destroyer(std::shared_ptr<TYPE> t)
...
template<class TYPE> 
void Destroyer<TYPE>::doomed(std::shared_ptr<TYPE> t)
...
template<class TYPE> std::shared_ptr<TYPE> Singleton<TYPE>::ins=nullptr;
...
{ // Return the singleton instance
	...
	if (ins==nullptr)
	{
		ins=std::shared_ptr<TYPE>(new TYPE);
		des.doomed(ins);
	}
