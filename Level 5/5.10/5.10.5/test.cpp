//test.cpp
//Author: TengxiaoFan
//This is the test file for some wrapped functions to find the range (generic template)
#include <iostream>
#include <vector>
#include <tuple>
#include <algorithm>
...
Result find_if_greater(const Container<T,TAlloc>& v, T x)
...
template <typename T, template <typename S, typename Alloc > class Container, typename TAlloc>
Result find_ifnot_greater(const Container<T,TAlloc>& v, T x)
...
template <typename T, template <typename S, typename Alloc > class Container, typename TAlloc>
Result2 find_index(const Container<T,TAlloc>& v, T x)
...
template <typename T, template <typename S, typename Alloc > class Container, typename TAlloc>
Result find_lb_greater(const Container<T,TAlloc>& v, T x)
...
template <typename T, template <typename S, typename Alloc > class Container, typename TAlloc>
Result find_ub_greater(const Container<T,TAlloc>& v, T x)
...
template <typename T, template <typename S, typename Alloc > class Container, typename TAlloc>
Result find_er_greater(const Container<T,TAlloc>& v, T x)
