...
template <typename T>
Result find_if_greater(const std::vector<T>& v, T x)
...
template <typename T>
Result find_ifnot_greater(const std::vector<T>& v, T x)
...
template<typename T> 
Result2 find_index(const std::vector<T>& v, T x)
...
template <typename T>
Result find_lb_greater(const std::vector<T>& v, T x)
...
template <typename T>
Result find_ub_greater(const std::vector<T>& v, T x)
...
template <typename T>
Result find_er_greater(const std::vector<T>& v, T x)
